...
#define member [MemberManager sharedInstance]

#ifdef DEBUG
#define DMLog(...) NSLog(__VA_ARGS__)
#define ServerAddress          @"test-healthrecord.kmhealthcloud.cn:8999"
#else
#define DMLog(...) do { } while (0)
#define ServerAddress          @"healthrecord.kmhealthcloud.cn:8999"
#endif
