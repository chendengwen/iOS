...
static NSString *const kBaseSegmentFilePath = @"/kmhc-modem-restful/services/member/";

#if Debug
#define Port_upload         @"8999"
#define Port_web            @"8060"
#define Port_HealthTest     @"8091"
#define Port_login          @"8090"
#define Port_image          @"8090"
#else
#define Port_upload         @"8999"
#define Port_web            @"8060"
#define Port_HealthTest     @"8091"
...
#if Debug
    return @"http://test-healthcloud.kmhealthcloud.cn:";
#else
    return kBaseURL;
#endif
}
