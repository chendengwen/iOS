...
/*
    ...
    fuc开头 --- 操作
 */
#define get_verifyCode_regist               @"app/member/regist_get"
#define get_verifyCode_forgetPassword       @"app/member/forgetPassword"
#define set_forgetPassword                  @"app/member/setPassBySms"

#define fuc_loginAuth                       @"login/loginSubmit"
#define fuc_registAuth                      @"app/member/auth"
