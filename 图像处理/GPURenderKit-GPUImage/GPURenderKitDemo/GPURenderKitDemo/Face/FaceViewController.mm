...
/**
 GLImageFaceChangeFilter 是人脸微整的效果。
 是把识别到的106个人脸关键点传到shader里面去，然后做像素的平移变化。
 你们可以先查看项目里面有一张图片。"人脸106个关键点.png"。
 */
- (void)setupFaceConfig{
    ...
    // 数据处理链：
    // videoCamera -> beautifyFilter -> faceChangeFilterGroup -> self.preview
