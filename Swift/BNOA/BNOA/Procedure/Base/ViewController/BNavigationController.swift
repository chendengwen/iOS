...
class BNavigationController: UINavigationController {
    ...
    override func viewDidLoad() {
        ...
        guard let internalTargets = interactiveGes.value(forKeyPath: "targets") as? [NSObject] else { return }
...
extension BNavigationController: UIGestureRecognizerDelegate {
...
extension UINavigationController {
    ...
    func barStyle(_ style: BNavigationBarStyle) {
        switch style {
        case .theme:
