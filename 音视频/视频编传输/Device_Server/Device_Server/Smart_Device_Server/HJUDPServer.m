...
@interface HJUDPServer()<GCDAsyncUdpSocketDelegate>
{
    BOOL                m_recvSignal;
    int                 m_sockfd;
...
//
//    NSError *error = nil;
//    [socket bindToPort:20002 error:&error];
//    if (error) {
//        NSLog(@"1:%@",error);
//        return -1;
//    }
...
-(void)recvDataAndProcess
{
    ...
    memset (&msgHead,0,sizeof(msgHead)); // 开辟内存空间
